<template>
    <section aria-label="Related models" class="mt-0 mb-3" v-if="models?.length">
        <p class="text-xs font-semibold mb-2 opacity-80">🔎 Related models</p>

        <!-- Grid: mobile two columns, sm -> four columns (adjust as needed) -->

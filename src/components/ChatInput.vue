    ...
    <div class="max-w-4xl mx-auto">
      <div class="relative bg-white rounded-full">
        ...
        <input
          ...
          :class="[
            'w-full resize-none border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200',
            allowFileUpload ? 'pl-12 pr-20' : 'pl-5 pr-20',
        ...
        <button 
          ...
          :class="[
            ...
            canSend 
              ? 'text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-full p-1' 
